# sirius-contract
The smart contracts behind [sirius.finance](https://sirius.finance)
...
The output in the `docs` folder should be copied to the appropriate folder in the [sirius-docs repo](https://github.com/sirius-finance/sirius-docs/tree/master/solidity-docs).
