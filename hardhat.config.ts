...
let config: HardhatUserConfig = {
  ...
  networks: {
    ...
    ropsten: {
      ...
      gasPrice: ethers.utils.parseUnits("10.81", "gwei").toNumber(),
      accounts: {
    ...
    kovan: {
      ...
      gasPrice: ethers.utils.parseUnits("2.81", "gwei").toNumber(),
      chainId: 42,
      accounts: {
        mnemonic: process.env.MNEMONIC_TEST_ACCOUNT,
      },
    ...
    bsctest: {
      url:
        ALCHEMY_BASE_URL[CHAIN_ID.BSC_TESTNET],
      chainId: 97,
      accounts: {
        mnemonic: process.env.MNEMONIC_TEST_ACCOUNT,
      },
    ...
    shibuya: {
      url:
        ALCHEMY_BASE_URL[CHAIN_ID.SHIBUYA],
      chainId: 81,
      accounts: {
        mnemonic: process.env.MNEMONIC_TEST_ACCOUNT,
      },
